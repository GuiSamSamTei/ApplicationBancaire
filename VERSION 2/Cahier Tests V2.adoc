...
5+|
^|ID ^|Action ^|Comportement attendu ^|Pré-conditions ^|Résultat
^|C_G_E.1 ^|Saisir l'idEmploye désiré dans le champ "Numéro" ^|On trouve l'employé associé à l'identifiant saisi ^|L'employé associé à l'identifiant existe ^|OK
^|C_G_E.2 ^|Saisir l'idEmploye d'un employé ^|On ne trouve aucun employé ^|L'employé associé à l'identifiant saisi n'existe pas ^|OK
5+|
...
5+|
^|ID ^|Action ^|Comportement attendu ^|Pré-conditions ^|Résultat
^|C_G_E.2 ^|Saisir le nom de l'employé désiré dans le champ "Nom" et cliquer sur "Rechercher" ^|On trouve des employés ^|Il y a des employés avec ce nom ^|OK
^|C_G_E.3 ^|Saisir le prénom de l'employé désiré dans le champ "Prénom" et cliquer sur "Rechercher" ^|On trouve des employés ^|Il y a des employés avec ce prénom ^|OK
^|C_G_E.4 ^|Saisir le nom/prénom de l'employé désiré dans les champs dédiés et cliquer sur "Rechercher" ^|On trouve des employés ^|Il y a des employés avec ces noms/prénoms ^|OK
5+|
...
5+|
^|ID ^|Action ^|Comportement attendu ^|Pré-conditions ^|Résultat
^|C_G_E.5 ^|Cliquer sur le bouton "Rechercher" ^|On trouve tous les employés de l'agence ^|Les champs de texte de recherche sont vides ^|OK
5+|
...
5+|
^|ID ^|Action ^|Comportement attendu ^|Pré-conditions ^|Résultat
^|C_G_E.6 ^|Cliquer sur le bouton "Modifier" ^|Une fenêtre s'ouvre pour modifier les informations de l'employé ^|Avoir sélectionné un employé ^|OK
^|C_G_E.7 ^|Modifier les informations et cliquer sur "Modifier" ^|Les informations de l'employé ont changé dans la base de données et dans la liste et la fenêtre se ferme ^|Avoir ouvert la fenêtre de modification ^|OK
^|C_G_E.8 ^|Modifier les informations et cliquer sur "Annuler" ^|La fenêtre se ferme et aucune modification est sauvegardée ^| Avoir ouvert la fenêtre de modification ^|OK
5+|
...
5+|
^|ID ^|Action ^|Comportement attendu ^|Pré-conditions ^|Résultat
^|C_G_E.9 ^|Cliquer sur le bouton "Modifier" ^|Une fenêtre s'ouvre pour modifier les informations de l'employé ^|Avoir sélectionné un employé ^|OK
^|C_G_E.10 ^|Modifier les informations et cliquer sur "Modifier" ^|Les informations de l'employé ont changé dans la base de données et dans la liste et la fenêtre se ferme ^|Avoir ouvert la fenêtre de modification ^|OK
^|C_G_E.11 ^|Modifier les informations et cliquer sur "Annuler" ^|La fenêtre se ferme et aucune modification est sauvegardée ^| Avoir ouvert la fenêtre de modification ^|OK
5+|
5+|Commentaire : Le bouton de modification s'active uniquement si on a sélectionné un employé.
